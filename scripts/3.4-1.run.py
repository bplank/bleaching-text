...
outDir = 'outputs/4.4-1/'
os.system('mkdir -p ' + outDir)

for tgtLang in ['EN', 'NL', 'PT', 'FR', 'ES']:
    for feat in [('.comb', '5', '0'), ('', '1-2', '3-6')]:    
        outFile = outDir + '/' + tgtLang + feat[0] + '.out'
        trainFile = 'data_4-1/4lang-data-200tweets.json.balanced' + feat[0] + '.' + tgtLang
        testFile = 'data_balanced_non_tokenized/' + tgtLang + '-data-200tweets.json.balanced' + feat[0]
